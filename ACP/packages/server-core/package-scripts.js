        ...
        db: {
                ...
                generate:{
                    script: series(
                            ...
                            "nps config",
                            runFast(
                                `${typeOrm} migration:generate src/database/ACP/migrations/${userInput} -d src/loader-cli/loader.ts`
                            )
                        ),
                    description:
                ...
                seed: {
                    script: series(
                        "nps banner.seed",
                        "nps config",
                        runFast(`dist/loader-cli/loader.js`)
                    ),
            ...
            migrate: {
                script: series(
                    ...
                    "nps config",
                    runFast(
                        `${typeOrm} migration:run -d src/loader-cli/loader.ts`
                    ),
